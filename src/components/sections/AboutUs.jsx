...
import { 
  Award, Layers, BarChart3, 
  Sparkles, ShieldCheck, 
  Users, Globe, Lightbulb, Target
} from 'lucide-react';
...
export default function AboutUs({ onOpenAudit, onNavigatePortfolio }) {
  const whatWeDoItems = [
    {
      ...
      desc: "Expand your presence across Meesho, Amazon, & Flipkart through strategic account management, catalog optimization, advertising support, and performance monitoring.",
      icon: Layers,
    ...
    },
    {
      ...
      desc: "Generate awareness, traffic, and sales through performance-driven marketing strategies tailored to your business objectives.",
      icon: BarChart3,
  ...
  const coreValues = [
    ...
    { title: "Innovation", desc: "Pioneering seller account growth for Meesho, Amazon, Flipkart & modern tech stacks.", icon: Lightbulb },
  ...
  return (
    <div className="bg-white text-slate-900 min-h-screen">
      ...
      {/* Top Header Banner */}
      <section className="py-16 bg-blue-950 text-white border-b border-blue-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-4 text-center">
          <div className="inline-flex items-center gap-2 bg-blue-900/80 text-sky-300 border border-blue-700/80 text-xs font-extrabold px-3.5 py-1.5 rounded-full uppercase tracking-wider">
          ...
          <p className="text-base sm:text-lg text-slate-300 max-w-3xl mx-auto font-normal">
            Helping brands grow across Meesho, Amazon, Flipkart, and digital channels through strategy, execution, and measurable results.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5 relative">
              ...
              <div className="absolute -bottom-5 -right-5 z-20 bg-blue-950 text-white p-5 rounded-2xl border border-blue-900 shadow-2xl max-w-xs">
                <div className="text-xs text-sky-300 font-extrabold uppercase">8+ Years Experience</div>
                <div className="text-xs text-slate-300 mt-0.5">Managing 500+ Active Seller Accounts Across India</div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <h2 className="text-3xl font-extrabold text-slate-950">
                Empowering India's Sellers & D2C Brands
              </h2>

              <p className="text-sm text-slate-600 leading-relaxed">
                Novasphere Innovations Private Limited is a full-service e-commerce growth agency headquartered in Indore, Madhya Pradesh. Founded by <strong>Yash Parmar</strong>, we specialize in end-to-end seller account management for <strong>Meesho, Amazon, and Flipkart</strong>.
              </p>

              <div className="p-4 bg-slate-50 rounded-2xl border border-slate-200 text-xs text-slate-700 space-y-1">
                <div>📍 <strong>Headquarters:</strong> {COMPANY_INFO.address}</div>
                <div>👤 <strong>Founder & Co-Founder:</strong> {COMPANY_INFO.founder}</div>
              </div>
            </div>
      ...
      <section className="py-16 bg-blue-950 text-white border-b border-blue-900">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
          ...
          <h2 className="text-2xl sm:text-3xl font-black text-white">Yash Parmar — Founder & Co-Founder</h2>

          <p className="text-xs text-slate-300 max-w-2xl mx-auto leading-relaxed">
            Novasphere Innovations Private Limited was founded with a simple but powerful belief: Every seller deserves access to the expertise, algorithms, and strategic execution required to scale sales on Meesho, Amazon, and Flipkart with confidence.
          </p>

          <blockquote className="text-lg sm:text-xl font-bold italic text-sky-300 max-w-3xl mx-auto">
            "Growth is not a destination. It is a continuous process of learning, improving, and creating value for every seller account we manage."
          </blockquote>
        </div>
      </section>
      ...
      <section className="py-16 bg-white text-center">
        <div className="max-w-3xl mx-auto px-4 space-y-6">
          ...
          <p className="text-sm text-slate-600">
            Whether you're launching a new seller account on Meesho, Amazon, or Flipkart, or looking to scale existing GMV & ROAS, we are here to help.
          </p>
          <div className="flex justify-center gap-4 pt-2">
            <button
              onClick={onOpenAudit}
              className="bg-blue-900 text-white font-bold text-xs px-6 py-3 rounded-xl hover:bg-blue-800 transition-colors shadow"
            >
